...
const news = [
  ...
  },
  {
    ...
    description:
      'Updates on Covid Situation in Asia, Europe and Other Continents.',
    href: '/news/covid',
    icon: GlobeIcon,
  },
  {
    ...
    <Popover className="relative bg-white shadow dark:bg-gray-700 dark:text-gray-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-4">
        <div className="flex justify-between items-center  py-4 ">
          ...
          <Popover.Group
            as="nav"
            className="hidden  xl:flex 2xl:flex items-center space-x-10"
          >
            <Link
              to="/"
      ...
      >
        <Popover.Panel
          focus
          className=" z-50 absolute top-0 inset-x-0 p-4 transition transform origin-top-right xl:hidden 2xl:hidden"
        >
